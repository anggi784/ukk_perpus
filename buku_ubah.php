            ...
            <form method="post">
               ...
               $id = $_GET['id'];
                    if (isset($_POST['submit'])) {
                        ...
                        $query = mysqli_query($koneksi, "UPDATE buku SET id_kategori='$id_kategori', judul_buku='$judul_buku', penulis='$penulis', penerbit='$penerbit', 
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                        <input type="text" value="<?php echo $data['tahun_terbit']; ?>"  class="form-control"name="tahun_terbit"></div>
                    </div>
                    <div class="row mb-3">
