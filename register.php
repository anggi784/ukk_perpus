                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <?php
                                            ...
                                            $insert = mysqli_query($koneksi, "INSERT INTO user(nama,username,password,email,alamat,no_telpon,level)
                                        ...
                                        <form method= "post">
                                            ...
                                            <label class="small mb-1">No.Telepon</label>
                                                <input class="form-control"  type="text" required name="no_telpon" placeholder="Masukan No.Telepon" />
                                            </div>
                                            <br>
                                            <div class="form-group">
